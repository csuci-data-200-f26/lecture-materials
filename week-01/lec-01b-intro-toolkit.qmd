...
::: {.column width="50%"}
Engine &emsp;&emsp;&emsp; Dashboard

```{r}
#| label: car-engine-img
#| echo: false
#| fig-alt: "Two pictures labeled 'R: Engine' and 'RStudio: Dashboard'. The engine picture shows a car engine. The dashboard shows a car dashboard with a lot of controls."
#| fig-cap: "From Modern Drive: An introduction to statistical and data sciences via R"
...
#| label: road-img
#| echo: false
#| fig-alt: "Cartoon image of a curvy road with a sign saying turn right. Straight in front is a lake."
#| fig-cap: "Designed by upklyak on Magnific www.magnific.com"

knitr::include_graphics("img/road-rules.jpg")
```
...
Insurance
```{r}
#| label: car-insurance-img
#| echo: false
#| fig-alt: "An illustration of an car covered with an umbrella and protected by a shield. Next to the car is a person holding forms titled 'INSURANCE POLICY'."
#| fig-cap: "Designed by Magnific www.magnific.com"

knitr::include_graphics("img/car-insurance.jpg")
```
...
knitr::include_graphics("img/coding-process-illustration.png")
```
...
Slides that you are currently looking at are also written in Quarto. You can take a look at them on our course's [GitHub organization](https://github.com/csuci-data-200-f26/lecture-materials) in the lecture repo.
