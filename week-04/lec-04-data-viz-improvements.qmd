...
Alt text for data visualizations should provide a brief description of the image (e.g., plot type, variables, range of data) **and** insight (e.g., trends, comparisons, ...) 
