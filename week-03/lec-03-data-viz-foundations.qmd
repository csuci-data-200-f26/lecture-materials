...
What type of variables can we display with a dodged bar plot?
...
What type of variables can we display with a dodged bar plot? **Two categorical variables**
...
```{r}
#| fig-align: center
ggplot(babies, aes(x = smoke, fill = parity)) + 
  geom_bar(position = "dodge")
```
