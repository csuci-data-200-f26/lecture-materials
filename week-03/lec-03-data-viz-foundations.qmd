...
We can represent data using: visuals, text, sound, tactiles.

. . .

Today we will cover the most commonly used format, but next week we will touch on different data representations.
